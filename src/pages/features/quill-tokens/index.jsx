...
const QuillTokens = () => {
  ...
  useEffect(() => {
    if (!results.length) {
      fetch(`${process.env.PUBLIC_URL}/quill-tokens.json`)
        .then((response) => {
          if (!response.ok) {
        ...
        .catch((error) => {
          console.error("Error fetching quill-tokens.json:", error);
        });
    }
  }, []);
    ...
    <div className="content-container">
      ...
      <div className="scroll-container">
        {isLoading ? (
          ...
          <>
            <SearchField
              placeholder="Search for token key or value"
              size="sm"
